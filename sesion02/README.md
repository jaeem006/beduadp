...
[**`Ejemplo 1`**](ejemplo01/boxplots.ipynb)
[**`Reto 1`**](reto01/boxplots.ipynb)
...
[**`Ejemplo 2`**](ejemplo02/tabla_de_frecuencias.ipynb)
[**`Reto 2`**](reto02/tabla_de_frecuencias.ipynb)
...
[**`Ejemplo 3`**](ejemplo03/histogramas.ipynb)
...
Describir nuestras distribuciones nos ayuda a comunicar nuestros hallazgos, así como también a encontrar técnicas específicas que podamos utilizar para analizar más a profundidad nuestros datos.

Aprendamos algunos de los términos más comunes.

> 

[**`Ejemplo 4`**](ejemplo04/describiendo_histogramas.ipynb)
[**`Reto 3`**](reto03/describiendo_histogramas.ipynb)
...
[**`Ejemplo 5`**](ejemplo05/graficas_de_densidad.ipynb)
[**`Reto 4`**](reto04/graficas_de_densidad.ipynb)
